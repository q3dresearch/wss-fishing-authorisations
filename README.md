# wss-fishing-authorisations — Fishing Authorisations History
...
A GitHub Actions pipeline that captures Fishing Authorisations History **every day** and publishes
